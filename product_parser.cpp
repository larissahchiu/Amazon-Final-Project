...
Product* ProductBookParser::parseSpecificProduct(std::string ,
        std::istream& is,
        bool& error,
        std::string& errorMsg,
        int& lineno)
...
Product* ProductClothingParser::parseSpecificProduct(std::string ,
        std::istream& is,
        bool& error,
        std::string& errorMsg,
        int& lineno)
...
Product* ProductMovieParser::parseSpecificProduct(std::string ,
        std::istream& is,
        bool& error,
        std::string& errorMsg,
        int& lineno)
